...
ds1 = netCDF4.Dataset('./dev.nc')

#print(ds)

ds1len = ds1.variables['seqLengths']
ds1in  = ds1.variables['inputs']
ds1out = ds1.variables['targetPatterns'] 

print(ds1len[:])
exstart =  0 #dslen[0]

exend = exstart + ds1len[0] #dslen[1]

mfcc_clean = ds1in [exstart:exend, :]
mfcc_noisy = ds1out[exstart:exend, :]
...
ds_mfcc_clean = dsin [exstart:exend, :] * stddevs + means
ds_mfcc_noisy = dsout[exstart:exend, :] * stddevs + means
